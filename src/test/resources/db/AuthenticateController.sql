...
INSERT INTO T_MFA_LOGIN(id, account_id, type, token, verification_id, scopes, admin, display_name, address)
    VALUES
        (100, 33, 1, '0000000', 333, 'user-read,payment-read', true, 'Ray Sponsible', '+23799509999');
